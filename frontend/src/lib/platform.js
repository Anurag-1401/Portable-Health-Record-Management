...
// export function shouldUseWebQrScanner() {
//   return !isNativePlatform() && isMobileWeb()
// }
...
/**
 * Browser camera is allowed only on mobile web.
 *
 * Desktop/PC browser deliberately returns false.
 */
export function shouldUseWebQrScanner() {
  return !isNativePlatform() && isMobileWeb()
}